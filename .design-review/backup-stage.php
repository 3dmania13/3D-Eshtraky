 ...
 */
    ...
    echo '<link rel="stylesheet" href="static/css/backup-reference.css?v=20260920">';
    echo '<div class="nawa-backup-page backup-reference" dir="rtl">';
    echo '<section class="backup-hero"><i class="bi bi-cloud-arrow-up"></i><div class="backup-hero-copy"><h1>إدارة النسخ الاحتياطية</h1><p>إنشاء وإدارة نسخ قاعدة البيانات والملفات المهمة للنظام، مع إمكانية الاستعادة عند الحاجة.</p></div><div class="backup-hero-side">نسخ احتياطية آمنة وموثوقة<small>حافظ على بياناتك واستمرارية الخدمة</small></div></section>';
    ...
    printf('<div class="nawa-backup-stat"><i class="bi bi-shield-check"></i><div><span>حالة النظام</span><strong>%s</strong></div></div>', $backup_dir_ready ? 'سليم' : 'تنبيه');
    echo '</div>';
