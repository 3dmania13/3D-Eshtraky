...
<body class="nawa-login-page">
    <div class="nawa-login-shell">
        <section class="nawa-login-panel">
            <div class="login-appearance"><button type="button" class="login-theme-toggle" aria-label="????? ?????? ??????" aria-pressed="false" title="????? ??????"><i class="bi bi-sun" aria-hidden="true"></i></button><span class="login-language"><i class="bi bi-globe2" aria-hidden="true"></i> ???????</span></div>
            <main class="nawa-login-card">
                ...
                <h1>?????? ??????</h1><span class="visually-hidden"><?= t('text', 'LoginRequired') ?></span>
                ...
                <form action="dologin.php" method="POST" autocomplete="on">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="operator_user" name="operator_user"
                               autocomplete="username" placeholder="???? ??? ????????" required autofocus><i class="bi bi-person login-field-icon" aria-hidden="true"></i>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="operator_pass" name="operator_pass"
                               autocomplete="current-password" placeholder="???? ???? ??????" required><i class="bi bi-lock login-field-icon" aria-hidden="true"></i><button class="login-password-toggle" type="button" aria-controls="operator_pass" aria-label="????? ???? ??????" aria-pressed="false"><i class="bi bi-eye" aria-hidden="true"></i></button>
                    </div>
...
?>
            ...
            <div class="login-security-note"><i class="bi bi-shield-check" aria-hidden="true"></i><span>3D Radius ? ???? ????? ??????</span></div>
        </section>
