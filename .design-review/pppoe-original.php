...
<section class="nawa-page-header">
 <div><h1>مشتركو PPPoE</h1><p>حسابات البرودباند منفصلة عن مستخدمي Hotspot الحاليين.</p></div>
...
<section class="nawa-stat-grid">
 <article class="nawa-stat"><span>إجمالي PPPoE</span><strong><?=number_format($totalUsers)?></strong></article>
 <article class="nawa-stat"><span>فعالة</span><strong><?=number_format($active)?></strong></article>
 <article class="nawa-stat"><span>معطلة / منتهية</span><strong><?=number_format($disabled)?></strong></article>
 <article class="nawa-stat"><span>مفعلة على RADIUS</span><strong><?=number_format($radiusEnabled)?></strong></article>
</section>
